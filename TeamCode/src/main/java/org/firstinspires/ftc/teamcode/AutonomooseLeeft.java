 ...
 */
@Disabled
@Autonomous(name = "Le_Gauche_Autonomousse", group = "Autonomous")

public class AutonomooseLeeft extends Auto_Util {
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            encoderStrafe(0.5, 18,18,10,0);
                            encoderDrive(1, 18, 18, 10, 0);
                            encoderLift(0.7, 18, 10, 0);
                            encoderDrive(0.5, 0.5, 0.5, 10, 0);
                            encoderLift(0.7, -1, 10, 0);
                            while(runtime.seconds() < 2) {
                                intakeServo.setPower(-1);
                            }
                            intakeServo.setPower(0);
                            encoderDrive(1, -0.5, -0.5, 10, 0);
                            encoderLift(0.7, -17, 10, 0);
                            if(objectDetected == "1 Bolt"){
                                encoderStrafe(1, -44, -44, 10, 0);
                                tfod.deactivate();
                                break;
                            }
                            else if (objectDetected == "2 Bulb"){
                                encoderStrafe(1, -28, -28, 10, 0);
                                tfod.deactivate();
                                break;
                            }
                            else if (objectDetected == "3 Panel"){
                                encoderStrafe(1, -18, -18, 10, 0);
                                tfod.deactivate();
                                break;
                            }
                            else {
